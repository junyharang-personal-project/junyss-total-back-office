...
public class ValidExceptionAdvisor {
	...
	public ResponseEntity<DefaultResponse<String>> processValidationException(
		...
		return new ResponseEntity<>(
			DefaultResponse.error(NOT_EXIST_SUGGEST, NOT_EXIST_SUGGEST.getMessage(), stringBuffer.toString()),
