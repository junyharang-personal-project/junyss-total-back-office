...
public class GlobalAPIExceptionAdvisor {
    ...
    @ExceptionHandler({IllegalArgumentException.class, HttpMessageNotReadableException.class, IOException.class, IllegalStateException.class})
    ...
    @ExceptionHandler({NoSuchElementException.class, SuggestException.class, CrewException.class, ErrorLogException.class})
    ...
    public DefaultResponse<Void> handleMethodArgumentNotValidException(BindException exception) {
        try {
            ...
            if (bindingResult.hasErrors()) {
                String bindResultCode = Objects.requireNonNull(Objects.requireNonNull(bindingResult.getFieldError()).getCode());
    ...
    public DefaultResponse<Void> handleAPICallException(Exception exception) {
        log.error("{}", exception);
        return DefaultResponse.error(ErrorCode.DISCORD_BOT_API_CALL_FAILURE, ErrorCode.DISCORD_BOT_API_CALL_FAILURE.getMessage());
    }
