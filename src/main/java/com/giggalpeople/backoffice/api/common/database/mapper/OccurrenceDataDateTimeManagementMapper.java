...
public interface OccurrenceDataDateTimeManagementMapper {
    ...
    @Select("select data_created_date_time_id from data_created_date_time where data_created_date = #{createdDate} and data_created_time = #{createdTime}")
    Long findByOccurrenceInfoDate(@Param("createdDate") String createdDate, @Param("createdTime") String createdTime);
}
