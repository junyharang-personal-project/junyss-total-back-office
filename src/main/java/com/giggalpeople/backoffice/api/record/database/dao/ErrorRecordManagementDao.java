...
public interface ErrorRecordManagementDao {
	...
	int totalErrorLogSearchCount(ErrorRecordSearchDto errorRecordSearchDto);
	...
	Optional<ErrorRecordTotalInfoVo> findByErrorLogTotalInfoSearchOneThing(ErrorRecordSearchDto errorRecordSearchDto);
	 ...
	 */
	List<ErrorRecordTotalInfoVo> findByErrorLogTotalInfoList(Criteria criteria,
	...
	Optional<ErrorRecordTotalInfoVo> detailErrorTotalInfoFind(String logId);
	...
	Optional<ErrorRecordTotalInfoVo> forGeneralCrewDetailErrorTotalInfoFind(String logId);
}
