...
public class ConnectedUserInfoController {
    ...
    public DefaultResponse<Map<String, Long>> save (@Valid @RequestBody UserRequestTotalInfoSaveRequestDTO userRequestTotalInfoSaveRequestDTO)  {
    ...
    public DefaultResponse<UserInfoDetailResponseDTO> toDiscordDetailConnectedUserInfoFind(@Valid @ModelAttribute("userInfoDetailSearchRequestDTO") UserInfoDetailSearchRequestDTO userInfoDetailSearchRequestDTO) {
