...
public class UserInfoDAOImpl implements UserInfoDAO {
	...
	public void updateConnectedSameRequestCount(UpdateUserRequestInfo updateUserRequestInfo) {
		...
		if (updateCount == null) {
			throw new ConnectedUserException(CONNECTED_USER_REQUEST_SAME_INFO_UPDATE_COUNT_SAVE_FAILURE,
				CONNECTED_USER_REQUEST_SAME_INFO_UPDATE_COUNT_SAVE_FAILURE.getMessage());
		}
	}
