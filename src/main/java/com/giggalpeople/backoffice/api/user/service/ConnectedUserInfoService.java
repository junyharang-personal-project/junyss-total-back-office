...
public interface ConnectedUserInfoService {
     ...
     */
    DefaultListResponse<List<UserInfoListResponseDTO>> toDiscordAllUserInfoFind(Criteria criteria, UserInfoSearchDTO userInfoSearchDTO);
    ...
    DefaultResponse<UserInfoDetailResponseDTO> toDiscordDetailConnectedUserInfoFind(UserInfoDetailSearchRequestDTO userInfoDetailSearchRequestDTO);
}
