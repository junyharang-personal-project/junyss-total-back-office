...
public interface CrewManagementDAO {
    ...
    int totalSuggestCrewSearchCount(CrewSuggestPeopleManagementSearchDTO crewSuggestSearchDTO, String crewSearchEncryptionValue);
    ...
    Optional<SuggestInfoVO> findByCrewSuggestInfoSearchOneThing(CrewSuggestPeopleManagementSearchDTO crewSuggestSearchDTO, String crewSuggestInfoSearchEncryption);
    ...
    List<SuggestInfoVO> findByCrewSuggestInfoList(Criteria criteria, CrewSuggestPeopleManagementSearchDTO crewSuggestSearchDTO, String crewSuggestInfoSearchEncryption);
    ...
    List<JoinInfoVO> findByCrewInfoList(Criteria criteria, CrewPeopleManagementSearchDTO crewSearchDTO, String crewSearchEncryptionValue);
     ...
     */
    Optional<JoinInfoVO> findByCrewInfoSearchOneThing(CrewPeopleManagementSearchDTO crewSearchDTO, String crewSearchEncryptionValue);
