...
public class CrewManagementDAOImpl implements CrewManagementDAO {
    ...
    public List<SuggestInfoVO> findByCrewSuggestInfoList(Criteria criteria, CrewSuggestPeopleManagementSearchDTO crewSuggestSearchDTO, String crewSuggestInfoSearchEncryption) {
        return crewManagementMapper.findByCrewSuggestInfoList(criteria, crewSuggestSearchDTO, crewSuggestInfoSearchEncryption);
    }
    ...
    @Transactional(readOnly = true)
    @Override
    public List<JoinInfoVO> findByCrewInfoList(Criteria criteria, CrewPeopleManagementSearchDTO crewSearchDTO, String crewSearchEncryptionValue) {
     ...
     */
    @Override
    public Optional<JoinInfoVO> findByCrewInfoSearchOneThing(CrewPeopleManagementSearchDTO crewSearchDTO, String crewSearchEncryptionValue) {
    ...
    @Transactional(readOnly = true)
    @Override
    public int totalSuggestCrewSearchCount(CrewSuggestPeopleManagementSearchDTO crewSuggestSearchDTO, String crewSuggestInfoSearchEncryption) {
    ...
    @Transactional(readOnly = true)
    @Override
    public Optional<SuggestInfoVO> findByCrewSuggestInfoSearchOneThing(CrewSuggestPeopleManagementSearchDTO crewSuggestSearchDTO, String crewSuggestInfoSearchEncryption) {
        return crewManagementMapper.findByCrewSuggestInfoSearchOneThing(crewSuggestSearchDTO, crewSuggestInfoSearchEncryption);
    }
