...
import com.giggalpeople.backoffice.chatops.logback.appender.discord.object.*;
...
public class DiscordWebHook {
    ...
    private JsonObject createDiscordEmbedObject(List<EmbedObject> embeds, JsonObject json) {
        if (embeds.isEmpty()) {
            throw new ErrorLogAppenderException(CREATE_DISCORD_APPEND_MESSAGE_FAILURE, CREATE_DISCORD_APPEND_MESSAGE_FAILURE.getMessage());
        }
