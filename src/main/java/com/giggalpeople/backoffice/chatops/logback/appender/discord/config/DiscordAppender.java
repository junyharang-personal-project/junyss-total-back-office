    ...
    protected void append(ILoggingEvent eventObject) {
        ...
        discordWebhook.addEmbed(new EmbedObject()
                ...
                .addField(
                        ...
                        StringEscapeUtils.escapeJson(mdcPropertyMap.get(MDCUtil.USER_LOCATION_MDC).replaceAll("[\\{\\{\\}]", "")),
                        false)
                .addField(
                ...
                .addField(
                        ...
                        StringEscapeUtils.escapeJson(mdcPropertyMap.get(MDCUtil.USER_REQUEST_COOKIES).replaceAll("[\\{\\{\\}]", "")),
                        false)
                .addField(
                        "[" + MDCUtil.PARAMETER_MAP_MDC + "]",
                        StringEscapeUtils.escapeJson(mdcPropertyMap.get(MDCUtil.PARAMETER_MAP_MDC).replaceAll("[\\{\\{\\}]", "")),
                        false)
